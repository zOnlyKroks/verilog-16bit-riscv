...
module instruction_memory (
    input  wire        clk,
    input  wire        rst_n,
    input  wire [3:0]  addr,        // Instruction address (4 bits for 16 bytes)
    ...
    initial begin
        ...
        // Simple test program: 4 instructions only
        ...
        // 0x00008193 = ADDI x3, x1, 0 (but using registers 0-3 only)
        memory[12] = 8'h93; // [7:0]   = opcode + rd[0]
        memory[13] = 8'h81; // [15:8]  = rd[4:1] + funct3 (x3 = rd[2:0] = 011)
