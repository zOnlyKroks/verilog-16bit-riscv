...
module register_file (
    input  wire        clk,
    input  wire        rst_n,
    input  wire [1:0]  read_addr1,   // Read port 1 address (rs1) - 2 bits for 4 regs
    input  wire [1:0]  read_addr2,   // Read port 2 address (rs2) - 2 bits for 4 regs
    input  wire [1:0]  write_addr,   // Write port address (rd) - 2 bits for 4 regs
    ...
    // Register array: 4 x 8-bit registers
