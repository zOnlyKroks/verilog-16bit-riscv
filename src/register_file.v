...
module register_file (
    input  wire        clk,
    input  wire        rst_n,
    input  wire [3:0]  read_addr1,   // Read port 1 address (rs1) - 4 bits, 16 registers
    input  wire [3:0]  read_addr2,   // Read port 2 address (rs2) - 4 bits, 16 registers
    input  wire [3:0]  write_addr,   // Write port address (rd) - 4 bits, 16 registers
    ...
    // Register array: 16 x 16-bit registers (x0-x15) - full 4-bit addressing
    ...
    assign data_out1 = (read_addr1 == 4'h0) ? 16'h0000 : registers[read_addr1];
    assign data_out2 = (read_addr2 == 4'h0) ? 16'h0000 : registers[read_addr2];
